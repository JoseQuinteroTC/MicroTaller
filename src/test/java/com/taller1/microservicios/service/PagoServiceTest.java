...
import static com.taller1.microservicios.model.enums.MetodoPago.TARJETA_CREDITO;
...
public class PagoServiceTest {
    ...
    void givenPago_whenUpdate_returnUpdatedPagoDto() {
        ...
        Pago updatedPago = Pago.builder()
                .id(pagoId)
                .fechaPago(LocalDateTime.of(2023, Month.DECEMBER,21,11,0))
                .totalPago(6500d)
    ...
    void whenFindByRangoFechaPago_returnPagoDtoList() {
        String initDate = "2023-12-31 12:00";
        String endDate = "2024-12-31 00:00";
        ...
        List<PagoDto> foundPagos = pagoService.buscarPagosByRangoFecha(initDate, endDate);
        Assertions.assertFalse(foundPagos.isEmpty());
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");
        for(PagoDto pago : foundPagos) {
            LocalDateTime fechaPago = pago.fechaPago();
            LocalDateTime fechaInicio = LocalDateTime.parse(initDate, formatter);
            LocalDateTime fechaFin = LocalDateTime.parse(endDate, formatter);
