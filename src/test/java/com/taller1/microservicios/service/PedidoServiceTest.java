...
import static com.taller1.microservicios.model.enums.EstadoPedido.ENVIADO;
...
public class PedidoServiceTest {
    ...
    void givenPedido_whenUpdate_returnUpdatedPedidoDto() {
        ...
        Pedido updatedPedido = Pedido.builder()
                .id(1L)
                .fechaPedido(LocalDateTime.of(2023, DECEMBER, 23, 0, 0))
                .estadoPedido(EstadoPedido.ENVIADO)
    ...
    void whenFindByRangoFechaPedido_returnPedidoDtoList() {
        String fechaInicioStr = "2023-12-31 12:00";
        String fechaFinStr = "2024-12-31 00:00";
